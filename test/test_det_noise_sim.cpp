...
TEST(DeterministicNoiseSimTest, ClassicControlledOp) {
    ...
    //    EXPECT_NEAR(std::abs(m.find("0000")->second , 0.0969332192741, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("0001")->second , 0.0907888041538, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("0010")->second , 0.0141409660985, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("0100")->second , 0.0238203475524, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("0101")->second , 0.0235097990017, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("0110")->second , 0.0244576087400, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("0111")->second , 0.0116282811276, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1000")->second , 0.1731941264570, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1001")->second , 0.4145855071998, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1010")->second , 0.0138062113213, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1011")->second , 0.0184033482066, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1100")->second , 0.0242454336917, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1101")->second , 0.0262779844799, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1110")->second , 0.0239296920989, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1111")->second , 0.0110373166627, tolerance);
    //}
    //
    ...
    //
    //    double tolerance = 1e-10;
    //    EXPECT_NEAR(std::abs(m.find("0000")->second , 0.0332328704931, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("0001")->second , 0.0328434857577, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("0010")->second , 0.0129643065735, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1000")->second , 0.0683938280189, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1001")->second , 0.7370101351171, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1010")->second , 0.0107812802908, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1011")->second , 0.0275086747656, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1100")->second , 0.0117061689898, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1101")->second , 0.0186346925411, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1110")->second , 0.0160082331009, tolerance);
    //}
    //
    ...
    //
    //    double tolerance = 1e-10;
    //    EXPECT_NEAR(std::abs(m.find("1000")->second , 0.03008702498522842, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1001")->second , 0.9364832248561167, tolerance);
    //}
    //
    ...
    //
    //    double tolerance = 1e-10;
    //    EXPECT_NEAR(std::abs(m.find("0000")->second , 0.0616548044047, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("0001")->second , 0.0570878674208, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("0100")->second , 0.0155601736851, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("0101")->second , 0.0157508473593, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("0110")->second , 0.0301651684817, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1000")->second , 0.1487734834937, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1001")->second , 0.5519250213313, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1011")->second , 0.0132640682125, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1100")->second , 0.0166178042857, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1101")->second , 0.0187340765889, tolerance);
    //    EXPECT_NEAR(std::abs(m.find("1110")->second , 0.0301853251959, tolerance);
    //}
}
