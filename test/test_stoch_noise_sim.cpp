...
TEST(StochNoiseSimTest, ApproximateByFidelity) {
    ...
    StochasticNoiseSimulator ddsim(std::move(quantumComputation), 54);
...
TEST(StochNoiseSimTest, SimulateClassicControlledOpWithError) {
    ...
    StochasticNoiseSimulator ddsim(std::move(quantumComputation), StochasticNoiseSimulator<>::Configuration{std::string("APD"), 0.02, std::optional<double>{}, 2, 1000, std::string("0-3"), false});
...
TEST(StochNoiseSimTest, SimulateAdder4WithDecoherenceAndGateError) {
    auto                     quantumComputation = stochGetAdder4Circuit();
    StochasticNoiseSimulator ddsim(std::move(quantumComputation), StochasticNoiseSimulator<>::Configuration{std::string("APD"), 0.1, std::optional<double>{}, 2, 1000, std::string("0-16"), false});
...
TEST(StochNoiseSimTest, SimulateAdder4WithDecoherenceAndGateErrorSelectedProperties) {
    auto                     quantumComputation = stochGetAdder4Circuit();
    StochasticNoiseSimulator ddsim(std::move(quantumComputation), StochasticNoiseSimulator<>::Configuration{std::string("APD"), 0.1, std::optional<double>{}, 2, 1000, std::string("4,8-15"), false});
...
TEST(StochNoiseSimTest, SimulateRunWithBadParameters) {
    EXPECT_THROW(const StochasticNoiseSimulator ddsim(stochGetAdder4Circuit(), StochasticNoiseSimulator<>::Configuration{std::string("AP"), 0.3, std::optional<double>{}, 2, 1000, std::string("0-1000"), false}), std::runtime_error);
    EXPECT_THROW(const StochasticNoiseSimulator ddsim(stochGetAdder4Circuit(), StochasticNoiseSimulator<>::Configuration{std::string("APK"), 0.01, std::optional<double>{}, 2, 1000, std::string("0-1000"), false}), std::runtime_error);
}

TEST(StochNoiseSimTest, SimulateAdder4WithDecoherenceError) {
    auto                     quantumComputation = stochGetAdder4Circuit();
    StochasticNoiseSimulator ddsim(std::move(quantumComputation), StochasticNoiseSimulator<>::Configuration{std::string("AP"), 0.01, std::optional<double>{}, 2, 1000, std::string("0-1000")});
...
TEST(StochNoiseSimTest, SimulateAdder4WithDepolarizationError) {
    auto                     quantumComputation = stochGetAdder4Circuit();
    StochasticNoiseSimulator ddsim(std::move(quantumComputation), StochasticNoiseSimulator<>::Configuration{std::string("D"), 0.01, std::optional<double>{}, 2, 1000, std::string("0-1000")});
...
TEST(StochNoiseSimTest, SimulateAdder4WithNoiseAndApproximation) {
    auto                     quantumComputation = stochGetAdder4Circuit();
    StochasticNoiseSimulator ddsim(std::move(quantumComputation), StochasticNoiseSimulator<>::Configuration{std::string("APD"), 0.01, std::optional<double>{}, 2, 1000, std::string("-2-1000")}, 1, 0.9);
...
TEST(StochNoiseSimTest, SimulateAdder4WithDecoherenceAndGateErrorUnoptimizedSim) {
    auto                     quantumComputation = stochGetAdder4Circuit();
    StochasticNoiseSimulator ddsim(std::move(quantumComputation), StochasticNoiseSimulator<>::Configuration{std::string("APD"), 0.1, std::optional<double>{}, 2, 1000, std::string("0-16")});
...
TEST(StochNoiseSimTest, ParseProperties) {
    auto                     quantumComputation = stochGetAdder4Circuit();
    StochasticNoiseSimulator ddsim(std::move(quantumComputation), StochasticNoiseSimulator<>::Configuration{std::string("APD"), 0.1, std::optional<double>{}, 2, 1000, std::string("0, 6, 1")});
    auto                     m = ddsim.stochSimulate();
...
TEST(StochNoiseSimTest, TestingBarrierGate) {
    ...
    quantumComputation->h(1);
    quantumComputation->h(0);
    StochasticNoiseSimulator ddsim(std::move(quantumComputation), StochasticNoiseSimulator<>::Configuration{std::string("APD"), 0.02, std::optional<double>{}, 2, 1000, std::string("0-3, 23, 444, 2")});
...
TEST(StochNoiseSimTest, TestingWithErrorProbZero) {
    auto                     quantumComputation = stochGetAdder4Circuit();
    StochasticNoiseSimulator ddsim(std::move(quantumComputation), StochasticNoiseSimulator<>::Configuration{std::string("APD"), 0, std::optional<double>{}, 2, 1000, std::string("0-15")});
...
TEST(StochNoiseSimTest, TestingWithEmpthyNoiseTypes) {
    auto                     quantumComputation = stochGetAdder4Circuit();
    StochasticNoiseSimulator ddsim(std::move(quantumComputation), StochasticNoiseSimulator<>::Configuration{std::string(""), 0.1, std::optional<double>{}, 2, 1000, std::string("0-15")});
