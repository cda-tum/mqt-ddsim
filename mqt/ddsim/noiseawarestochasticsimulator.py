...
class StochasticNoiseSimulatorBackend(BackendV1):
    ...
    def __init__(self, configuration=None, provider=None) -> None:
        conf = {
            "backend_name": "stochastic_qasm_simulator",
    ...
    def run_experiment(self, qobj_experiment: QasmQobjExperiment, **options):
        ...
        sim = StochasticNoiseSimulator(qobj_experiment, seed=seed, nthreads=nthreads)
