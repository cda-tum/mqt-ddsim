...
qc::MatrixDD ParallelizationSimulator::simulateMatrixMatrixBasic(const std::unique_ptr<qc::QuantumComputation>& qc, const qc::MatrixDD& initialMatrix, std::unique_ptr<dd::Package>& ddPackage, std::vector<std::unique_ptr<qc::Operation>>::iterator iter) {
...
std::vector<std::unique_ptr<qc::Operation>>::iterator ParallelizationSimulator::getWarmUpDepth(const std::unique_ptr<qc::QuantumComputation>& qc, std::unique_ptr<dd::Package>& ddPackage) {
    // create the iterator
