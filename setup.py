...
setup(
    ...
    extras_require={
        ...
        "tests": ["pytest", "qiskit-terra>=0.19.2,<0.23.0"],
        "docs": ["Sphinx==5.3.0", "sphinx-rtd-theme==1.1.1", "sphinx-rtd-dark-mode", "sphinxcontrib-bibtex==2.5.0", "sphinx-copybutton==0.5.1", "sphinxext-opengraph"],
    }
)
